...
class Tree(object):
    ...
    def depth_first_search(self, data):
        ...
        # FIXME
        # LIFO - pop and append on the end of the stack.
        # while list is not empty
        # if node data does not match the input data, then pop item 
        # and append it's children to the end of the list. 
        # Keep following this pattern until it reaches the end of the branch
        # if node data does not match input data.
